...
const EnterpriseCertification: React.FC = (props) => {
  ...
  let localPath = '/customer/certification/enterprise-certification';
  return (

      pathname === localPath ? <PageContainer
        ...
        <ProTable<API.RuleListItem, API.PageParams>
          ...
          toolBarRender={() => [
            <Button
              ...
              key="primary"
              onClick={() => {
                history.push('/customer/certification/enterprise-certification/enterprise-application')
              }}
            >
              <PlusOutlined /> 新建
           </Button>,
